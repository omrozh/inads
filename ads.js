...
if(adElements.length == 0){
    var insertbanner = '<div id=autoplacedb style="margin-top: -20%; position: sticky; position: -webkit-sticky; right: 0; top: 0; z-index: 1;"><img class="inads" name=inadsbanner src="" alt="" style="">';
