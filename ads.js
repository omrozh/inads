...
if(adElements.length == 0){
    var insertbanner = '<div id=autoplacedb style="padding: 50% 0; height: 0; .rotation { transform-origin: 0 0; transform: rotate(-​90deg) translate(-100%); margin-top: -50%; white-space: nowrap position: sticky; position: -webkit-sticky; right: 0; top: 0; z-index: 1;"><img class="inads" name=inadsbanner src="" alt="" style="">';
