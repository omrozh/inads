...
if(adElements.length == 0){
    var insertop = '<img class="inads" name=inadstandard src="" alt="" style="margin-left: 12.5%; position: fixed; margin-bottom: 10%">';
    ...
    document.body.insertAdjacentHTML("afterbegin", insertop);
