...
if(adElements.length == 0){
    var insertbanner = '<img class="inads" name=inadsbanner src="" alt="" style="float: right; position: fixed; right: 0">';
    var insertad = '<div style="margin-top: 10%"><img class="inads" name=inadstandard src="" alt="" style="margin-left: 12.5%;"><div>';
